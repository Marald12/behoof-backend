...
import { NestedEnumArticleContentTypesWithAggregatesFilter } from './nested-enum-article-content-types-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumArticleContentTypesFilter } from './nested-enum-article-content-types-filter.input';

@InputType()
export class EnumArticleContentTypesWithAggregatesFilter {
